...
export class BladderBossComponent {
  ...
  designSystemImages: string[] = ['/case-studies/BladderBoss-1.png', '/case-studies/BladderBoss-2.png', '/case-studies/BladderBoss-3.png'];

  uiArchitectureImages: string[] = ['/case-studies/BladderBoss-Home.png', '/case-studies/BladderBoss-Diary.png', '/case-studies/BladderBoss-Profile.png'];
